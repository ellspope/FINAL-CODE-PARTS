    ...
    while (1) 
    {
        switch(current_state) 
        {
            case LINEFOLLOW: // If current_state == LINEFOLLOW
                ...
                else if (ADC1BUF10 >= 1240 && ADC1BUF11 >= 1240 && ADC1BUF9 >= 1240 && ADC1BUF13 >= 1861 && _RB8 == 0) { // All line QRDs see black and right sharp sensor sees wall and left prox 
            ...
            case CANYON: // If current_state == CANYON
                ...
                //if(canyon_counter == 1){
                    //current_state = LINEFOLLOW;
                //}
//                if (ADC1BUF10 <= QRDthreshold || ADC1BUF11 <= QRDthreshold || ADC1BUF9 <= QRDthreshold && canyon_counter ==1) {
